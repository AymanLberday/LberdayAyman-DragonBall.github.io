...
// J'ai utilisé le fichier Vehicle.js de 6-ObstacleAvoidance et j'ai rajouté quelques fonctions de vehicle.js de 3-Arrival :

// Assez compliqué comme Puzzle mais l'essenciel c'est que ca marche !! haha

//J'ai utilisé cette classe pour que mes autres classes héritent ses propriétés et comme ca c'est plus facile .
...
class Personnage {
  ...
  //-----------------------------------Pris de 6-ObstacleAvoidance ------------------------------------------------------------
    constructor(x, y) {
      ...
      // ---------------------------------Pris de vehicle.js de 3-arrival--------------------------------------------------
    ...
    avoid(obstacles, considereVehiculesCommeObstacles = false) {
      ...
      if (considereVehiculesCommeObstacles) {
        vehiculeLePlusProche = this.getVehiculeLePlusProche(personnages);
