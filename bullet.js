...
// Comment faire un jeu dragon ball sans l'attaque spéciale ultime de SANGOKU (c'est le personnage principal , je ne sais pas si vous avez vu DBZ)
// Si ce n'est pas le cas , regardez DBZ !!
...
class Kamehameha {
    ...
    show() {
      ...
      image(kamehamehaImage, -this.r, -this.r, this.r * 2, this.r * 2);
      pop();
      if (Kamehameha.debug) {
